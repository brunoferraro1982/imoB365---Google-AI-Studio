...
- **[Clique aqui para baixar o Caderno de Testes em formato Planilha (.CSV)](/caderno_de_testes_imob365.csv)**
  > _Dica:_ O arquivo está salvo no padrão brasileiro (separado por `;`). Ao abrir no Excel ou Google Sheets, os acentos e colunas serão exibidos automaticamente de forma limpa e estruturada.
