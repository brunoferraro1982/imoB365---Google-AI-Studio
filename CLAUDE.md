...
- Aplicar em dev (Supabase Cloud) a migration `20260715150000_payment_events_amount.sql` (`payment_events.amount`/`currency`) — achada faltando na auditoria de paridade de 2026-07-23 (ver changelog); já está aplicada em produção
