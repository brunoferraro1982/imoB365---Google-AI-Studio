...
export function ModuleSubNav({ items, current }: { items: SubItem[]; current: string }) {
  ...
  return (
    <nav className="scrollbar-none sticky top-15 z-20 flex gap-1.5 overflow-x-auto border-b border-sidebar-border/70 bg-sidebar/95 px-3 py-2 text-sidebar-foreground backdrop-blur-md md:hidden print:hidden">
      {items.map((item) => {
