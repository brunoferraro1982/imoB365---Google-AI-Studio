    ...
    <div className="p-8">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">Catálogo de módulos disponíveis na plataforma.</p>
        </div>
      </div>
          ...
          <div key={m.slug} className="rounded-xl border border-border bg-card p-5">
            <div className="flex items-start justify-between gap-2">
              <div>
                ...
                <p className="mt-0.5 text-xs text-muted-foreground">slug: {m.slug} · v{m.versao}</p>
              </div>
            ...
            <div className="mt-3 flex items-center justify-between text-xs text-muted-foreground">
              <span>Ativos em <strong className="text-foreground">{counts[m.slug] ?? 0}</strong> tenants</span>
