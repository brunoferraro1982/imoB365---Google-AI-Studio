    ...
    <form onSubmit={save} className="max-w-3xl space-y-6">
      <section className="rounded-xl border border-border bg-card p-6">
        ...
        <p className="mb-4 text-xs text-muted-foreground">
          Aparece no site público e em e-mails. PNG/SVG até 2MB.
        </p>
      ...
      <section className="rounded-xl border border-border bg-card p-6">
        ...
        <p className="mb-4 text-xs text-muted-foreground">
          Aponte um CNAME para{" "}
          <code className="rounded bg-muted px-1 py-0.5">app.lovableimob.com</code> e confirme
          abaixo.
        </p>
        <Field label="Seu domínio">
          <div className="flex items-center gap-2">
            ...
            <Input
              ...
              placeholder="site.minhaimobiliaria.com.br"
              maxLength={255}
            />
          </div>
        </Field>
        {dominio && (
          <div className="mt-3 flex items-center gap-2 rounded-md border border-border bg-muted/30 p-3 text-xs">
            ...
            <span>
              Aguardando verificação DNS. Após apontar o CNAME, salve para iniciar a validação.
            </span>
          </div>
        )}
        {!dominio && tenant.slug && (
          <div className="mt-3 flex items-center gap-2 rounded-md border border-border bg-muted/30 p-3 text-xs">
            ...
            <span>
              URL ativa: <span className="font-mono">{tenant.slug}.lovableimob.com</span>
            </span>
          </div>
        )}
      </section>
