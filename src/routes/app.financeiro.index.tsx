  ...
  const totals = useMemo(() => {
    ...
    for (const l of items) {
      ...
      if (l.status === "pendente" || l.status === "atrasado")
        pendentes += v * (l.tipo === "receita" ? 1 : -1);
    }
    ...
    <div className="p-8">
      ...
      <div className="mb-6 grid gap-4 md:grid-cols-4">
        ...
        <Stat
          ...
          icon={Banknote}
          className={totals.saldo >= 0 ? "text-emerald-600" : "text-red-600"}
        />
        <Stat
          label="Em aberto"
      ...
      {loading ? (
        ...
        <div className="rounded-xl border border-dashed border-border p-12 text-center">
          ...
          <Link to="/app/financeiro/novo" className="mt-4 inline-block">
            ...
            <tbody>
              {filtered.map((l) => (
                <tr key={l.id} className="border-b border-border last:border-0">
                  ...
                  <td
                    className={`px-4 py-3 text-right font-medium ${l.tipo === "receita" ? "text-emerald-600" : "text-red-600"}`}
                  >
