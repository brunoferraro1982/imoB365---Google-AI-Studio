          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <h2 className="text-base font-bold text-foreground">
                Rede de Co-corretagem & MLS imob365
              </h2>
              <p className="text-xs text-muted-foreground">
                Compartilhe sua carteira de imóveis com corretores parceiros e divida comissões
                automaticamente de forma segura.
              </p>
            </div>
          </div>
          <div className="flex items-center gap-2">
            ...
            <Switch
              ...
              onCheckedChange={(v) => {
                ...
                toast.success(
                  v
                    ? "Sua carteira está disponível na rede MLS!"
                    : "Compartilhamento ocultado temporariamente.",
                );
              }}
            />
          </div>
            ...
            <div className="space-y-4">
              <div className="grid gap-3 sm:grid-cols-2">
                <div className="p-4 bg-muted/40 border border-border/50 rounded-lg space-y-1">
                  <span className="text-[10px] text-muted-foreground uppercase font-bold tracking-wide">
                    Acordo de Split de Comissão
                  </span>
                  <div className="flex items-center gap-1.5 pt-1">
                    <span className="text-sm font-bold text-foreground">
                      {comissionSplit} Padrão
                    </span>
                    <Badge
                      variant="outline"
                      className="text-[9px] uppercase bg-emerald-50 text-emerald-700 hover:bg-emerald-50 border-emerald-200"
                    >
                      Garantido
                    </Badge>
                  </div>
                  <p className="text-[10px] text-muted-foreground leading-normal">
                    50% para o captador do imóvel e 50% para o corretor que trouxer o lead
                    qualificado comprador/inquilino.
                  </p>
                </div>
                ...
                <div className="p-4 bg-muted/40 border border-border/50 rounded-lg space-y-1">
                  ...
                  <p className="text-[10px] text-muted-foreground leading-normal">
                    Seus imóveis ativos estão visíveis para todos os corretores e imobiliárias
              ...
              <div className="border border-border rounded-lg bg-background p-4 space-y-3">
                ...
                <p className="text-[11px] text-muted-foreground leading-relaxed">
                  Quando ativado, nossa IA monitora as buscas salvas de imobiliárias parceiras da
                  região. Se um imóvel seu coincidir com o perfil, um alerta de lead qualificado é
                  gerado instantaneamente no seu painel.
                </p>
                <div className="flex items-center gap-2 pt-1">
                  <Switch
                    ...
                    onCheckedChange={(v) => {
                      setAutoMatchPool(v);
                      toast.success(
                        v ? "Auto-matching reativado para parcerias." : "Auto-matching desligado.",
                      );
                    }}
                  />
                  <span className="font-medium text-muted-foreground text-[11px]">
                    Permitir IA sugerir de forma cruzada
                  </span>
                </div>
              </div>
            </div>
