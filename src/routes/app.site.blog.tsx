...
function BlogManagerPage() {
    ...
    const defaultPosts: BlogPost[] = [
      {
        ...
        resumo:
          "Dicas práticas passo-a-passo para valorizar cada detalhe do seu imóvel antes da sessão profissional de fotos.",
        imagem_url:
        ...
        seo_description:
          "Aprenda como preparar ambientes para obter fotos de imóveis perfeitas e valorizar seu patrimônio nos portais.",
      ...
      },
      {
        ...
        resumo:
          "Confira as projeções de juros, valorização do metro quadrado e tendências de inovação imobiliária para este ano.",
        imagem_url:
        ...
        seo_description:
          "Fique por dentro das projeções de expansão, juros imobiliários e preços para o segundo semestre de 2026.",
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      ...
      if (
        currentPost.id &&
        currentPost.id.length > 5 &&
        !currentPost.id.startsWith("1") &&
        !currentPost.id.startsWith("2")
      ) {
        try {
          await (supabase as any).from("blog_posts").update(payload).eq("id", currentPost.id);
        } catch (supabaseErr) {
        ...
        const newId =
          currentPost.id && (currentPost.id === "1" || currentPost.id === "2")
            ? currentPost.id
        ...
        try {
          await (supabase as any).from("blog_posts").insert({ ...payload, id: newId });
        } catch (supabaseErr) {
          ...
          <header className="mb-8 flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground max-w-2xl">
                Crie artigos para melhorar o ranqueamento orgânico (SEO) da sua imobiliária, educar
                clientes e gerar mais contatos qualificados.
              </p>
            </div>
                    ...
                    <div>
                      ...
                      >
                        ...
                        <span className="text-[10px] text-muted-foreground">
                          Editor de Rich-markup integrado
                        </span>
                      </Label>
                      <Textarea
                        id="post-conteudo"
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-muted/40 p-3 rounded-lg border border-border/50 text-2xs space-y-1.5 text-muted-foreground">
                      ...
                      <div className="flex justify-between">
                        ...
                        <Badge className="text-[9px] uppercase font-mono px-1 py-0 bg-primary/20 text-primary border-none">
                          PRO
                        </Badge>
                      </div>
                    </div>
