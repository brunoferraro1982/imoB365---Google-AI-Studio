            ...
            <div className="rounded-2xl border border-border bg-card p-6 shadow-xs sticky top-24">
              ...
              <div className="space-y-4">
                <div className="space-y-1.5">
                  <Label htmlFor="fin-valor" className="text-xs font-bold text-muted-foreground">
                    Valor do Imóvel
                  </Label>
                ...
                <div className="space-y-1.5">
                  <Label htmlFor="fin-entrada" className="text-xs font-bold text-muted-foreground">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="space-y-1.5">
                    <Label htmlFor="fin-prazo" className="text-xs font-bold text-muted-foreground">
                      Prazo (Meses)
                    </Label>
                    <Input
                      id="fin-prazo"
                  ...
                  <div className="space-y-1.5">
                    <Label htmlFor="fin-taxa" className="text-xs font-bold text-muted-foreground">
                      Taxa Anual (%)
                    </Label>
                    <Input
                      id="fin-taxa"
                ...
                <div className="border-t border-border pt-4 mt-2 space-y-3">
                  ...
                  <div className="flex justify-between items-center bg-emerald-500/[0.02] p-3 rounded-xl border border-emerald-500/10">
                    <div className="space-y-0.5">
                      <span className="text-3xs text-emerald-700 font-bold uppercase leading-none block">
                        Última Parcela
                      </span>
                      <span className="text-[10px] text-muted-foreground leading-none block">
                        Fase mais baixa
                  ...
                  <div className="flex justify-between items-center bg-primary/[0.03] p-3.5 rounded-xl border border-primary/10">
                    <div className="space-y-0.5">
                      ...
                      <span className="text-3xs text-muted-foreground leading-none block">
                        Principal + {formatBRL(financiamentoResult.totalJuros)} juros
                      </span>
                    </div>
            ...
            <article className="prose prose-slate max-w-none space-y-6">
              ...
              <div className="space-y-3">
                <h2 className="text-lg font-bold text-foreground flex items-center gap-2">
                  <Landmark className="h-5 w-5 text-primary shrink-0" /> O que é o Sistema de
                  Amortização Constante (SAC)?
                </h2>
                <p className="text-sm text-muted-foreground leading-relaxed">
                  O <strong>SAC</strong> é a modalidade de financiamento imobiliário mais contratada
                  no Brasil. Sua grande vantagem reside no seu modelo de cálculo:{" "}
                  <strong>
                    o valor deduzido da dívida principal (a amortização) permanece rigorosamente
                    idêntico do início ao fim do prazo
                  </strong>
                  .
                </p>
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Dado que os juros mensais incidem apenas sobre o saldo devedor restante (e esse
                  saldo devedor decola para baixo em parcelas fixas reais a cada mês), os juros
                  devidos encolhem sequencialmente. Por este motivo, as prestações mensais do
                  sistema SAC são decrescentes — começam no valor máximo e reduzem gradativamente
              ...
              <div className="space-y-3">
                <h2 className="text-lg font-bold text-foreground flex items-center gap-2">
                  <Percent className="h-5 w-5 text-emerald-600 shrink-0" /> SAC vs. Tabela Price:
                  Qual é a diferença?
                </h2>
                ...
                <div className="space-y-3 text-xs leading-relaxed text-muted-foreground">
                  <div className="flex gap-2.5">
                    ...
                    <p>
                      ...
                      Se o seu comprador teme perder renda ou comprometer-se por períodos longos de
                      30 anos, demonstre analiticamente que no SAC a prestação é uma ladeira
                      descendente. Já nas primeiras 60 parcelas, as prestações ficam bastante leves,
                      reduzindo em muito a exposição do orçamento doméstico.
                    </p>
                  </div>
                  ...
                  <div className="flex gap-2.5">
                    ...
                    <p>
                      ...
                      Instrua o cliente a poupar e utilizar o saldo do FGTS a cada 2 anos para
                      amortizar saldo devedor. Isso faz com que contratos originalmente previstos
                      para 30 anos (360 meses) possam ser finalizados com segurança em menos de 10
                      ou 12 anos, reduzindo os juros finais à metade.
                    </p>
                  </div>
                  ...
                  <div className="flex gap-2.5">
                    ...
                    <p>
                      <strong>A Regra dos 30% de Comprometimento:</strong>A maior barreira de recusa
                      de crédito bancária é exceder 30% da renda comprovada bruta familiar na
                      parcela inicial. Ajude o comprador a balancear a entrada no formulário de
                      simulação acima para encontrar o montante exato necessário para garantir uma
                      aprovação rápida e sem atritos técnicos.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-2 border-t border-border pt-4">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Financiar um lar é uma das decisões financeiras mais memoráveis da vida de uma
                  família brasileira. Ter contato com números precisos, entender que as taxas de
                  juros no mercado de habitação variam de instituição para instituição e usar
                  simuladores confiáveis ajuda a construir autoridade comercial e criar uma relação
                  justa e tranquila entre a imobiliária e o comprador.
                </p>
              </div>
            </article>
          </div>
