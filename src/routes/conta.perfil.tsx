...
function PerfilPage() {
  ...
  return (
    <div>
      ...
      <form onSubmit={salvar} className="mt-8 max-w-lg space-y-4 rounded-xl border border-border bg-card p-6">
        <div>
        ...
        <div>
          ...
          <p className="mt-1 text-xs text-muted-foreground">Para alterar o e-mail, entre em contato com o suporte.</p>
        </div>
      ...
      <div className="mt-6 max-w-lg rounded-xl border border-border bg-card p-6">
        ...
        <p className="mt-1 text-xs text-muted-foreground">Enviaremos um link de redefinição para seu e-mail.</p>
