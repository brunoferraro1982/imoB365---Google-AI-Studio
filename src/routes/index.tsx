...
function _SiteHeader() {
  return (
    <header className="sticky top-0 z-40 border-b border-border/70 bg-background/85 backdrop-blur-md shadow-xs transition-all duration-300">
        ...
        <div className="mx-auto max-w-6xl flex flex-col sm:flex-row items-center justify-between gap-2.5">
          ...
          <div className="flex flex-wrap items-center justify-center sm:justify-start gap-5 text-white/80">
            <a href="mailto:contato@imob365.com.br" className="flex items-center gap-2 hover:text-primary transition-colors duration-200">
              <Mail className="h-3 w-3 text-primary shrink-0 transition-transform hover:scale-110" />
            ...
            <a href="tel:5513997794382" className="flex items-center gap-2 hover:text-primary transition-colors duration-200">
              <Phone className="h-3 w-3 text-primary shrink-0 transition-transform hover:scale-110" />
          ...
          <div className="flex items-center gap-3.5">
            <span className="text-white/40 uppercase text-[9px] tracking-widest font-bold font-sans">Idioma:</span>
      ...
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-6 py-4">
        ...
        <nav className="hidden items-center gap-6 text-sm font-semibold lg:flex">
          <Link to="/buscar" className="flex items-center gap-1.5 text-foreground/85 hover:text-primary transition-colors relative group py-1">
            <Building2 className="h-4 w-4 opacity-75 group-hover:opacity-100 group-hover:stroke-[2.25px] transition-all" />
            <span>Comprar</span>
            <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-primary group-hover:w-full transition-all duration-200" />
          </Link>
          <Link to="/buscar" className="flex items-center gap-1.5 text-foreground/85 hover:text-primary transition-colors relative group py-1">
            <Key className="h-4 w-4 opacity-75 group-hover:opacity-100 group-hover:stroke-[2.25px] transition-all" />
            <span>Alugar</span>
            <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-primary group-hover:w-full transition-all duration-200" />
          </Link>
          <a href="/#recursos" className="flex items-center gap-1.5 text-foreground/85 hover:text-primary transition-colors relative group py-1">
            <Sparkles className="h-4 w-4 opacity-75 group-hover:opacity-100 group-hover:stroke-[2.25px] transition-all" />
            <span>Para imobiliárias</span>
            <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-primary group-hover:w-full transition-all duration-200" />
          </a>
          <Link to="/planos" className="flex items-center gap-1.5 text-foreground/85 hover:text-primary transition-colors relative group py-1">
            <CreditCard className="h-4 w-4 opacity-75 group-hover:opacity-100 group-hover:stroke-[2.25px] transition-all" />
            <span>Planos</span>
            <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-primary group-hover:w-full transition-all duration-200" />
          </Link>
          <a href="/#parceiros" className="flex items-center gap-1.5 text-foreground/85 hover:text-primary transition-colors relative group py-1">
            <Users className="h-4 w-4 opacity-75 group-hover:opacity-100 group-hover:stroke-[2.25px] transition-all" />
            <span>Parceiros</span>
            <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-primary group-hover:w-full transition-all duration-200" />
          </a>
          
          {/* CALCULADORAS - DESTAQUE ARROJADO */}
          <Link
            to="/calculadoras"
            className="flex items-center gap-2 px-3.5 py-1.5 rounded-full text-xs font-bold bg-gradient-to-r from-primary/10 to-orange-500/10 text-primary border border-primary/30 shadow-2xs hover:shadow-md hover:shadow-primary/10 hover:border-primary hover:from-primary hover:to-orange-600 hover:text-white transition-all duration-300 relative group"
          >
            <Calculator className="h-4 w-4 stroke-[2px] transition-transform group-hover:rotate-12" />
            <span>Calculadoras</span>
            <span className="text-[9px] bg-primary group-hover:bg-white text-white group-hover:text-primary px-1.5 py-0.5 rounded-full font-black tracking-wider uppercase transition-colors">
              ITBI/Financ.
            </span>
          </Link>
        </nav>
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="lg:hidden">
            <Sheet>
              ...
              <SheetContent side="right" className="w-[300px] sm:w-[360px] p-0 flex flex-col bg-background/95 backdrop-blur-md">
                ...
                <div className="flex-1 overflow-y-auto px-4 py-6 space-y-6">
                  <div className="space-y-1">
                    <h3 className="px-3 text-2xs font-extrabold uppercase tracking-widest text-muted-foreground/80 mb-3">
                      Navegação Comercial
                    </h3>
                    
                    <Link to="/buscar" className="flex items-center gap-3.5 px-3 py-3 rounded-xl hover:bg-primary/5 text-foreground font-semibold text-sm transition-all group">
                      ...
                      <div className="flex flex-col">
                        ...
                        <span className="text-3xs text-muted-foreground font-medium">As melhores residências e prédios</span>
                      </div>
                    </Link>
                    ...
                    <Link to="/buscar" className="flex items-center gap-3.5 px-3 py-3 rounded-xl hover:bg-primary/5 text-foreground font-semibold text-sm transition-all group">
                      ...
                      <div className="flex flex-col">
                        ...
                        <span className="text-3xs text-muted-foreground font-medium">Contratos ágeis e sem fiador</span>
                      </div>
                    </Link>

                    <Link to="/planos" className="flex items-center gap-3.5 px-3 py-3 rounded-xl hover:bg-primary/5 text-foreground font-semibold text-sm transition-all group">
                      <div className="p-2 bg-primary/10 text-primary rounded-lg group-hover:bg-primary group-hover:text-white transition-colors">
                        <CreditCard className="h-4 w-4" />
                      </div>
                      <div className="flex flex-col">
                        <span>Planos e preços</span>
                        <span className="text-3xs text-muted-foreground font-medium">Opções para corretores e agências</span>
                      </div>
                    </Link>
                  </div>
                  ...
                  <div className="space-y-1">
                    ...
                    <a href="/#recursos" className="flex items-center gap-3.5 px-3 py-3 rounded-xl hover:bg-primary/5 text-foreground font-semibold text-sm transition-all group">
                      <div className="p-2 bg-primary/10 text-primary rounded-lg group-hover:bg-primary group-hover:text-white transition-colors">
                        <Sparkles className="h-4 w-4" />
                      </div>
                      <div className="flex flex-col">
                        <span>Para imobiliárias</span>
                        <span className="text-3xs text-muted-foreground font-medium">Tudo o que sua agência precisa</span>
                      </div>
                    </a>

                    <a href="/#parceiros" className="flex items-center gap-3.5 px-3 py-3 rounded-xl hover:bg-primary/5 text-foreground font-semibold text-sm transition-all group">
                      <div className="p-2 bg-primary/10 text-primary rounded-lg group-hover:bg-primary group-hover:text-white transition-colors">
                        <Users className="h-4 w-4" />
                      </div>
                      <div className="flex flex-col">
                        <span>Nossos parceiros</span>
                        <span className="text-3xs text-muted-foreground font-medium">Soluções locais e integradas</span>
                      </div>
                    </a>
                  </div>

                  {/* MINI CARD CALCULADORAS EM DESTAQUE NO MOBILE */}
                  <div className="p-1">
                    <Link to="/calculadoras" className="block overflow-hidden rounded-2xl bg-gradient-to-br from-primary to-orange-600 p-5 text-white shadow-md relative group">
                      <div className="absolute right-0 bottom-0 opacity-15 translate-x-4 translate-y-4 group-hover:scale-110 transition-transform duration-300">
                        <Calculator className="h-28 w-28" />
                      </div>
                      <div className="relative z-10 space-y-2">
                        <span className="inline-flex items-center gap-1 bg-white/20 text-[9px] font-black tracking-widest uppercase px-2 py-0.5 rounded-full">
                          Destaque
                        </span>
                        <h4 className="font-bold text-base">Financiamento & ITBI</h4>
                        <p className="text-3xs opacity-85 leading-relaxed">
                          Descubra o valor exato das parcelas e do imposto municipal gratuitamente antes de fechar negócio. Simulação rápida.
                        </p>
                        <div className="pt-2 flex items-center text-xs font-bold gap-1 group-hover:translate-x-1 transition-transform">
