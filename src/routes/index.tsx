...
function Landing() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground animate-fade-in">
      ...
      {/* CALCULADORA DE VALOR DO IMÓVEL */}
      <section className="border-b border-border bg-gradient-to-br from-emerald-50 via-background to-background dark:from-emerald-950/10">
        <div className="mx-auto max-w-6xl px-6 py-14">
          <div className="flex flex-col items-start gap-6 rounded-3xl border border-emerald-200/70 bg-card p-8 dark:border-emerald-900/40 md:flex-row md:items-center md:justify-between md:p-10">
            <div className="flex items-start gap-4">
              ...
              <div>
                <span className="inline-block rounded-full bg-emerald-100 px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider text-emerald-800 dark:bg-emerald-900/40 dark:text-emerald-400">
                  Novo
                </span>
                ...
                <p className="mt-2 max-w-xl text-sm text-muted-foreground">
                  Informe CEP, metragem, tipo e padrão do imóvel e receba, em segundos, uma
                  estimativa de valor de venda ou aluguel com base em médias de mercado da sua
                  região.
                </p>
            ...
            <Link to="/calculadora-avaliacao" className="shrink-0">
